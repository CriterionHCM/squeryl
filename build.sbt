...
//  },
  ...
  publishTo := Some(
    "CritertionHCM Nexus" at "https://nexus.criterionhcm.com/repository/criterion-release"
  ),
  credentials ++= Seq(
    Credentials(baseDirectory.value / ".nexus_credentials"),
    Credentials(baseDirectory.value / ".release_credentials")
  ),
